...
<body>
	...
	<div class="heading">
		<h1>Add Objective Type Questions </h1>
	</div>
		<div class="container">
			<div class="agile-form">
                    
<form action="qadd.jsp" onsubmit="return myFunction()">
					...
					<li>
						   ...
						   <input type="radio" id="other1" name="quet" value="ranking" required>Ranking Questions
 					<br>
 						<label class="form-label"><span class="form-required"></span></label>	 <input type="radio" id="other1" name="quet" value="matching pair" required>Matching Pair Questions
  							<br>
  						<label class="form-label"><span class="form-required"></span></label>	<input type="radio" id="other1" name="quet" value="true false" required> True False Questions
 						
 						<br>
  						<label class="form-label"><span class="form-required"></span></label>	<input type="radio" id="other1" name="quet" value="multiple choice" required> Multiple Choice Questions
 						
 						<br>
  						<label class="form-label"><span class="form-required"></span></label>	<input type="radio" id="other1" name="quet" value="fill in the blanks" required> Fill In The Blanks
                ...
                for(int i=0;i<vlist.size();i++)
            {
             ...
             %>
					...
					<li> 
							<label class="form-label"> option  <span class="form-required"> * </span></label>
							<div class="form-input">
								<input type="text" name="option" pattern="[1,2,3,4,5,6,7,8,9,0]{2}"minlength="1" maxlength="2"  style="width: 30%;" placeholder="option"  required >
							</div>
						</li>
