...
<form action="sadd.jsp" onsubmit="return myFunction()">
...
<li>
							<label class="form-label">Subject Name<span class="form-required"> * </span></label>
							<div class="form-input">
								
									<input type="text"  name="sub" placeholder="Subject Name"   maxlength="250"  required>
