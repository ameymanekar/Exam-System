	...
	<div class="heading">
		...
		<div class="container">
			<div class="agile-form">
				...
				<form action="supdatefrm.jsp">
				<ul class="field-list">
						<li class="name">


							<label class="form-label">Vehicle Name <span class="form-required"> * </span></label>
							<div class="form-input">
								
									<input type="text"  value="<%=resultSet.getString("sub") %>"  name="sub" placeholder="Subjects name"  required>
							
									<input type="hidden"  value="<%=resultSet.getString("sid") %>"  name="sid"  required>
