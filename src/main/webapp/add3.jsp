...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
   ...
   <body>         
<center>
  <div class="enjoy-css2"> Search Question </div>
<table bstyle="width:100%" cellpadding="25px" cellspacing="25px" >
<form action="searchq.jsp">
  <tr><td>  <input type="submit"class="enjoy-css" value="Objective Questions "  /></td>
    
</form>
<form action="searchdesq.jsp">
    <td><input type="submit"class="enjoy-css" value="Descriptive Questions" /></td>
