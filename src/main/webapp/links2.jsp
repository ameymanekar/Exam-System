...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
    ...
    <center>
        ...
        <img src="images/qb.png" width="100%" height="100%" >
       <hr><center>
       <div class="enjoy-css5">Welcome: <%=(String)session.getAttribute("userid")%> </div> 
        ...
        <table cellspacing="15px" >
        	...
        	<form action="home2.jsp" target="f2"> 
     		...
     		<form action="add2.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="Add Question "/></td></tr></form>
        	
        	<form action="add3.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="Search Question "/></td></tr></form>
        	
        		<form action="course.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="   Add Subjects   "/></td></tr></form>
        	
        	
        	<form action="addcs.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="    Subjects       "/></td></tr></form>
