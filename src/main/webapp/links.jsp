...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
    ...
    <body class="page" >
        ...
        <center>
       <div class="enjoy-css5"></div> 
     
        </center>
        <table cellspacing="15px" >
         
        	<form action="home.jsp" target="f2"> 
        	...
        	<form action="addcs.jsp" target="f2">
     		...
     		<form action="teacherinfo.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="  Teacher Info   "/></td></tr></form>
